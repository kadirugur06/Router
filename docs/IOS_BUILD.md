...
abonelik/paywall ekranını (₺1.799,99/ay — App Store Connect'te
belirlenen gerçek fiyat) gösteriyor. Abonelik fiyatını ileride
değiştirirseniz bu görseli de güncellemeyi unutmayın (aksi halde Apple,
ekran görüntüsü ile gerçek fiyat arasındaki tutarsızlık nedeniyle
reddedebilir). İstersen simülatörde `Cmd+S` ile kendi görüntülerini de alabilirsin. Uygulama adı, alt başlık, açıklama,
